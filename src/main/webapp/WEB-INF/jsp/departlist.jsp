...
<div id="win" class="easyui-window" title="修改部门" closed="true" style="width:600px;height:400px;padding:5px;">
		...
		<label><h1>修改部门</h1></label> <p>
		<label>部门编号：</label><input class="easyui-numberbox" type="text" name="dNo" style="width: 280px;display:none;" data-options="required:true"><p>
		<label>部门名称：</label><input  class="easyui-textbox" type="text" name="dName" data-options="required:true" style="width: 280px;"><p>
...
<label>部门名称：</label><input  class="easyui-textbox" type="text" name="dName" data-options="required:true" style="width: 280px;"value=${development.dName}><p>
<label>部门编号：</label><input class="easyui-numberbox" type="text" name="dNo" style="width: 280px;" data-options="required:true" value=${development.dNo}><p>
<label>部门备注：</label><input class="easyui-textbox" name="dNote" 
						data-options="multiline:true,validType:'length[0,150]'" style="height:60px;width: 280px;" value=${development.dNote}></input><p>
	</script>
	<a 
		id="btn_add" 
		href="#" 
